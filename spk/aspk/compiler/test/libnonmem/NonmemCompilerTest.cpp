...
void NonmemCompilerTest::testConstructor()
{
  char input[] = "NonmemCompilerTestInput.xml";
...
void NonmemCompilerTest::testTranslate()
{
  char input[] = "NonmemCompilerTestInput.xml";
...
CppUnit::Test * NonmemCompilerTest::suite()
{
  ...
  suiteOfTests->addTest( new CppUnit::TestCaller<NonmemCompilerTest>("testConstructor",
						    &NonmemCompilerTest::testConstructor ) );

  suiteOfTests->addTest( new CppUnit::TestCaller<NonmemCompilerTest>("testTranslate",
						    &NonmemCompilerTest::testTranslate ) );
