...
const char* NonmemTranslator::C_STD_TWO_STAGE              ( "std_two_stage" );
const char* NonmemTranslator::C_GLOBAL_TWO_STAGE           ( "global_two_stage" );
const char* NonmemTranslator::C_ITERATIVE_TWO_STAGE        ( "iterative_two_stage" );
