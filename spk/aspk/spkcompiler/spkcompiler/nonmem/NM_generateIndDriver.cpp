...
void NonmemTranslator::generateIndDriver( ) const
{
 ...
 oIndDriver << "         if( isStatRequested && isOptRequested && isOptSuccess )" << endl;
  ...
  oIndDriver << "               for( int j=0, k=0; j<n; j++ )" << endl;
  oIndDriver << "               {" << endl;
  oIndDriver << "                  for( int i=0; i<n-j; i++, k++ ) // lower only" << endl;
  oIndDriver << "                  {" << endl;
  oIndDriver << "                     full[ (j*n)+(j+i) ] = omegaIn[k];" << endl;
  oIndDriver << "                  }" << endl;
  oIndDriver << "               }" << endl;
  oIndDriver << endl;
  ...
  oIndDriver << endl;
  oIndDriver << "               // Read the lower triangle in the row-major order" << endl;
  ...
  oIndDriver << "                  for( int i=0; i<n-j; i++, k++ ) // lower only" << endl;
  oIndDriver << "                  {" << endl;
  oIndDriver << "                     full[ (j*n)+(j+i) ] = omegaOut[k];" << endl;
  oIndDriver << "                  }" << endl;
  oIndDriver << "               }" << endl;
  oIndDriver << endl;
  oIndDriver << "               // Copy the lower triangle to the upper and complete fullification" << endl;
