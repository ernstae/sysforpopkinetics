...
/*************************************************************************
 *
 * Function: read_nonmem_datafile_gamma_wt_time_y
 *
 *************************************************************************/
...
/*
$begin read_nonmem_datafile_gamma_wt_time_y$$
$spell 
    const
    Nsum
    spk
    ...
    yi
    gammai
    read_nonmem_datafile_gamma_wt_time_y
    Theophylline
    wi
    cout
    endl
...
$index read_nonmem_datafile_gamma_wt_time_y$$

$table
$bold Prototype:$$   $cend  
$syntax/int read_nonmem_datafile_gamma_wt_time_y(
...
$head Description$$
The routine $code read_nonmem_datafile_gamma_wt_time_y$$ reads a data file that has the following form:
...
A specification for the arguments to $code read_nonmem_datafile_gamma_wt_time_y$$ and the actual C++ code follow below.
...
* /name/
/$$
This argument is an input to $code read_nonmem_datafile_gamma_wt_time_y$$.
...
& /M/
/$$
This argument is an output for $code read_nonmem_datafile_gamma_wt_time_y$$.  
...
$codep
    ...
    void main()
    {
        ...
        //
        // Prepare place holders.  The sizes and contents will be modified by read_nonmem_datafile_gamma_wt_time_y().
        //
        int numIndividuals;
        int sumMeasurements;
        ...
        read_nonmem_datafile_gamma_wt_time_y( filename, numIndividuals, sumMeasurements, numMeasurements, gammas, weights, times, measurements );
...
$head Source Code$$
This following source code is stored in the file $italic read_nonmem_datafile_gamma_wt_time_y.cpp$$

$code

$verbatim%read_nonmem_datafile_gamma_wt_time_y.cpp%0%//BEGIN%//END%1%$$
