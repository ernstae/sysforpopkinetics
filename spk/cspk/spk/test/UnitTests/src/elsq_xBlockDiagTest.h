...
/*************************************************************************
 *
 * File: elsq_xBlockDiagTest.h
 *
 *
 * Declare elsq_xBlockDiagTest class.
 *
 * Author: Jiaji Du
 *
 *************************************************************************/
#ifndef ELSQ_XBLOCKDIAG_TEST_H
#define ELSQ_XBLOCKDIAG_TEST_H
...
class elsq_xBlockDiagTest : public CppUnit::TestFixture
{
