...
void calcGroebnerBasisTest::paperTwoCompExample_Test()
{
  ...
  try
  {
    ...
    // exhaustive summary.
    nGroebnerBasisPoly = calcGroebnerBasis(
      level,
      nTheta,
      thetaSeed,
      nComp,
  ...
  //----------------------------------------------------------
  // Get the Groebner basis polynomials and free their memory.
  //----------------------------------------------------------

  // These C++ style strings will contain all of the calculated
  // polynomials.
  vector<string> groebnerBasisPoly( nGroebnerBasisPoly );
  ...
  for ( m = 0; m < nGroebnerBasisPoly; m++)
  {
    ...
    groebnerBasisPoly[m] = string( groebnerBasisPolyCStrOut[m] );
  ...
  // polynomials.
  vector<string> groebnerBasisPolyKnown( nGroebnerBasisPoly );
  ...
  //     THETA7 = 18
  // 
  groebnerBasisPolyKnown[0] = "THETA6*THETA7 - 378";
  groebnerBasisPolyKnown[1] = "THETA5 - 24";
  groebnerBasisPolyKnown[2] = "18*THETA4 - 17*THETA7";
  groebnerBasisPolyKnown[3] = "18*THETA3 - 7*THETA7";
  groebnerBasisPolyKnown[4] = "THETA2 - 22";
  groebnerBasisPolyKnown[5] = "THETA1 - 1";
  ...
  // Compare each of the calculated Groebner basis polynomials to
  // their known value.
  for ( m = 0; m < nGroebnerBasisPoly; m++)
  {
    if ( groebnerBasisPolyKnown[m] != groebnerBasisPoly[m] )
    {
      CPPUNIT_ASSERT_MESSAGE( 
        "The calculated and known values for groebnerBasisPoly[m] do not agree.",
        false );
    }
  }
