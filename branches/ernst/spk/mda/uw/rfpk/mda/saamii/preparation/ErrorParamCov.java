 ...
 * @author  Jiaji Du
 */
public class ErrorParamCov extends javax.swing.JDialog {
    
    /** Creates new form ErrorParamCov */
    public ErrorParamCov(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        int dimension = 3;
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle("Residual Unknown Variability Covariance");
        ...
        jTextArea1.setText("Enter initial estimates of the covariance matrix of residual unknown\nvariability.  Append an \"F\" to the number if the parameter is fixed.\nNote: You must press the \"Enter\" key after typing in the last element.");
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    public static void main(String args[]) {
        new ErrorParamCov(new javax.swing.JFrame(), true);
    }
