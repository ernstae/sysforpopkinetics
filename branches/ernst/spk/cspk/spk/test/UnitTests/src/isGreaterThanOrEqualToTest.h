...
*/
#ifndef ISGREATERTHANOREQUALTOTEST_H
#define ISGREATERTHANOREQUALTOTEST_H
...
class isGreaterThanOrEqualToTest : public CppUnit::TestFixture
{
    int * nRows;
    int * nCols;
    int n;
