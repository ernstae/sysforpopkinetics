...
distribution.
**********************************************************************/
package org.netbeans.ui.wizard.plaf;

import javax.swing.plaf.ComponentUI;
import org.netbeans.ui.wizard.JWizardPane;

/** This class defines wizard pane UI.
 */
public abstract class WizardPaneUI extends ComponentUI {

    /**
     * Requests the component representing the default value to have
     * focus.
     * @param wp a JWizardPane object for setting default button.
     */
//    public abstract void selectInitialValue(JWizardPane wp);
    public abstract void selectDefaultButton(JWizardPane wp);
}
