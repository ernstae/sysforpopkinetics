                                ...
                                std::vector<spk_ValueType>& spk_depVar )
{
   ...
   assert( ( spk_etaLen == 1 && spk_epsLen == 1 ) ||
           ( spk_etaLen == 1 && spk_epsLen == 0 ) );   // Allow these for two-stage methods.
   ...
   if ( spk_epsLen != 0 )
   {
      // Skip this if there are no eps values.
...
//=========================================
   ...
   if( spk_i == 100-1 && spk_j == spk_perm->data[spk_i]->ID.size()-1 )
   {
