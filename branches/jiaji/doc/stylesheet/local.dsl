...
<!--
;;######################################################################
;;    RFPK Custom Stylesheet Layer
;;    
;;    This was originally a copy of the GNOME custom stylesheet layer
;;    installed as part of docbook-utils-0.6.11-2.rpm from the RH8.0
;;    distribution.  Note that this Stylesheet defines options. The
;;    real work is done by Norman Walsh's Modular Stylesheets, which
;;    it includes.
;;
;;######################################################################
-->
