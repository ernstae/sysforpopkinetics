...
public class Test {
    ...
    public static void main(String[] args)
    {
        ...
        String[] msg1 = {"Value of objective is different.",
                         ...
                         "Value of presentation data at row 1, column 3 is different.",
                         "Value of presentation data at row 2, column 3 is different.",
        ...
        String[] msg2 = {"Value of objective is different.",
                         "Value of THETA 2 is different.",
                         ...
                         "Value of likelihood standard error center 2 is different.",
                         "Value of likelihood standard error upper 3 is different."};
        String[] msg3 = {"Value of objective is different.",
                         "Value of THETA 2 is different.",
                         "Value of OMEGA block 1 is different.  index = 3",
                         "Value of SIGMA block 1 is different.  index = 1",
                         "Covariance matrix is different.  index = 3",
                         ...
                         "Value of likelihood standard error center 2 is different.",
                         "Value of likelihood standard error upper 3 is different."};
        String[] msg4 = {"Value of objective is different.",
                         "Value of THETA 2 is different.",
                         "Value of SIGMA block 1 is different.  index = 1",
                         "Inverse covariance matrix is different.  index = 1",
                         "Value of presentation data at row 1, column 3 is different.",
        ...
        try
        {
            for(int i = 1; i <= 4; i++)
            {
                ...
                String[] command = {"java", "-cp", cp, className, oldResult, newResult, oldSource, rErr, aErr, norm};
