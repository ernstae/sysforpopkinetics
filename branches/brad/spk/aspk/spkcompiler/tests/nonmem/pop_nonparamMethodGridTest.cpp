...
if( actual != expected ) \\\n \
 { \\\n \
  ...
  const string auto_generate_method = "grid";
...
void pop_nonparamMethodGridTest::setUp()
{
  okToClean = false;
...
void pop_nonparamMethodGridTest::tearDown()
{
  if( okToClean )
    {
      remove( fDataML );
...
//
//******************************************************************************
void pop_nonparamMethodGridTest::createDataML()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_nonparamMethodGridTest::createSourceML()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
// 
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void pop_nonparamMethodGridTest::parse()
{
  //============================================
...
void pop_nonparamMethodGridTest::testIndDataClass()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_nonparamMethodGridTest::testDataSetClass()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_nonparamMethodGridTest::testPredClass()
{ 
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_nonparamMethodGridTest::testDriver()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
void pop_nonparamMethodGridTest::testReportML()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  // Test driver.cpp to see if it compiles/links successfully.
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
CppUnit::Test * pop_nonparamMethodGridTest::suite()
{
  CppUnit::TestSuite *suiteOfTests = new CppUnit::TestSuite( "pop_nonparamMethodGridTest"  );
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_nonparamMethodGridTest>(
         "testIndDataClass", 
	 &pop_nonparamMethodGridTest::testIndDataClass ) );
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_nonparamMethodGridTest>(
         "testDataSetClass", 
	 &pop_nonparamMethodGridTest::testDataSetClass ) );
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_nonparamMethodGridTest>(
         "testPredClass", 
	 &pop_nonparamMethodGridTest::testPredClass ) );
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_nonparamMethodGridTest>(
         "testDriver", 
	 &pop_nonparamMethodGridTest::testDriver ) );
  return suiteOfTests;
}
