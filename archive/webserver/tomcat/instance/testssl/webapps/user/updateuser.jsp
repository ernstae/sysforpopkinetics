	  ...
	  <td colspan=1 vAlign=top>
	    <h3>Updating User Account</h3>
            <p>
              ...
              <table>
                <sql:query var="user">
                  SELECT user_id,username,first_name,surname,company,country,state,email,test,dev,team_id FROM user WHERE user_id = ?
