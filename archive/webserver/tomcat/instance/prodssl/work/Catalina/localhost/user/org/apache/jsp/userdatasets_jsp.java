...
public final class userdatasets_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("  <head>\n");
      out.write("    <title>User Dataset List</title>\n");
      out.write("  </head>\n");
      ...
      out.write("\t    <h3>User Dataset List</h3>\n");
      out.write("\t    <p> \n");
      out.write("              ");
      ...
      out.write("\n");
      out.write("              ");
      uw.rfpk.beans.DatasetList datasets = null;
      synchronized (request) {
        datasets = (uw.rfpk.beans.DatasetList) _jspx_page_context.getAttribute("datasets", PageContext.REQUEST_SCOPE);
        if (datasets == null){
          datasets = new uw.rfpk.beans.DatasetList();
          _jspx_page_context.setAttribute("datasets", datasets, PageContext.REQUEST_SCOPE);
        }
      }
      out.write("\n");
      out.write("              ");
 int maxNum = Integer.parseInt(getServletContext().getInitParameter("maxNum")); 
      ...
      out.write("\n");
      out.write("                     The following user datasets are found:\n");
      out.write("                 <p>\n");
