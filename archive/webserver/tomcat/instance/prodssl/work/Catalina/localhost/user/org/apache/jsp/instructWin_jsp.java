...
public final class instructWin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("<head>\n");
      out.write("   <title>Instructions for Installing JRE on Windows</title>\n");
      ...
      out.write("\t    <h3>Instructions for Installing JRE on Windows</h3>\n");
      out.write("\t    <p> \n");
      out.write("              1.  To use the MDA, you need the Java Runtime Environment (JRE) from Sun Microsystems. \n");
      out.write("                  To download and install the JRE, access the following website:<br>\n");
      out.write("                  <a href=\"http://java.sun.com/j2se/1.4.2/download.html\" target=\"_blank\">http://java.sun.com/j2se/1.4.2/download.html</a>.\n");
      out.write("            </p><p>\n");
      out.write("              2.  Scroll down to \"Download J2SE JRE\" and click the link.\n");
      out.write("            </p><p>\n");
      out.write("              3.  Accept the License Agreement (by scrolling down and clicking on\n");
      out.write("                  \"Accept\").\n");
      out.write("            </p><p>\n");
      out.write("              4.  You should see \"Java(TM) 2 Runtime Environment, Standard\n");
      out.write("                  Edition\", and then the version number.\n");
      out.write("            </p><p>\n");
      out.write("              5.  Under the \"Windows Platform\" choose \"Windows Installation...\",  \n");
      out.write("                  choose \"Run\" when prompted by the File Download window, and choose \"Run\" when prompted by the Security Warning window.\n");
      out.write("            </p><p>\n");
      out.write("              6.  The InstallShield Wizard should start. Accept license aggreement, and choose \"typical setup type\". Click \"Finish\" when the installation is complete.  On setup, we recommend that you do not accept the MDA desktop icon.  Currently the MDA will not load from the icon.\n");
      out.write("            </p><p>\n");
      out.write("              7.  FOR MOZILLA OR NETSCAPE USERS: If you use Mozilla or Netscape as your\n");
      out.write("                  web browser, you must set the helper application to be Java Web Start.<br>\n");
      out.write("                  Select Edit->Preferences->Navigator->Helper Applications->New Type.\n");
      out.write("                  Enter FileExtension as \"jnlp\"<br>\n");
      out.write("                  Enter MIME type as \"Application/x-java-jnlp-file\"<br>\n");
      out.write("                  Enter Handled by Application as<br>\n");
      out.write("                  \"C:\\Program Files\\Java\\j2re1.4.2_05\\javaws\\javaws.exe\", then click the \"OK\" buttons.\n");
      out.write("            </p><p>\n");
      out.write("                  Note that the version number may be different in the future.\n");
      out.write("\t    </p>\n");
      out.write("\t  </td>\n");
      out.write("\t</tr>\n");
      out.write("      </tbody>\n");
