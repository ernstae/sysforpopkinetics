  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (request) {
        models = (uw.rfpk.beans.ModelList) _jspx_page_context.getAttribute("models", PageContext.REQUEST_SCOPE);
        if (models == null){
          models = new uw.rfpk.beans.ModelList();
          _jspx_page_context.setAttribute("models", models, PageContext.REQUEST_SCOPE);
        }
      }
      out.write("\n");
      out.write("              ");
