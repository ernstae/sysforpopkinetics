...
<html>
  ...
  <body bgcolor="white">
    ...
    <sql:query var="userList"
      sql="SELECT user_id,username,first_name,surname,company,country,state,email,test,dev,team_id FROM user WHERE username!='useradmin' AND username!='librarian' ORDER BY surname" 
