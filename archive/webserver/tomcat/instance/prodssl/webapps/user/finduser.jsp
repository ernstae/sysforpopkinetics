...
<html>
  ...
  <body bgcolor="white">
    ...
    <sql:query var="userList" startRow="${param.start}" maxRows="${noOfRows}">
      SELECT user_id,username,first_name,surname,company,country,state,email,test,dev,team_id FROM user WHERE user_id LIKE ? AND username LIKE ? AND first_name LIKE ? AND surname LIKE ?  
