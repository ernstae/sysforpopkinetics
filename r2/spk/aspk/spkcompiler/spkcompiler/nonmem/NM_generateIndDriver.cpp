...
void NonmemTranslator::generateIndDriver( ) const
{
  ...
  oIndDriver << "      {" << endl;
  oIndDriver << "         finish(FILE_ACCESS_ERROR);" << endl;
  oIndDriver << "         return FILE_ACCESS_ERROR;" << endl;
  oIndDriver << "      }" << endl;
  oIndDriver << "   }" << endl;
  ...
  oIndDriver << "         ret = FILE_ACCESS_ERROR;" << endl;
  oIndDriver << "      }" << endl;
  ...
  oIndDriver << "      double zero = 0.0;" << endl;
  oIndDriver << endl;
  oIndDriver << "      // Initially set all of these equal to Not a Numbers (NaN) to" << endl;
  oIndDriver << "      // indicate that their values have not yet been calculated." << endl;
  oIndDriver << "      iPredOut   = zero / zero;" << endl;
  oIndDriver << "      iResOut    = zero / zero;" << endl;
  oIndDriver << "      iResWtdOut = zero / zero;" << endl;
  oIndDriver << endl;
  ...
  oIndDriver << "               goto REPORT_GEN;" << endl;
  oIndDriver << "            }" << endl;
  oIndDriver << "            catch( const std::exception& stde )" << endl;
  oIndDriver << "            {" << endl;
  oIndDriver << "               char message[] =\"A standard exception occurred in data simulation.\";" << endl;
  oIndDriver << "               SpkError e( stde, message, __LINE__, __FILE__ );" << endl;
  oIndDriver << "               errors.push( e );" << endl;
  oIndDriver << "               haveCompleteData = false;" << endl;
  oIndDriver << "               ret = SIMULATION_ERROR;" << endl;
  oIndDriver << "               goto REPORT_GEN;" << endl;
  ...
  oIndDriver << "            {" << endl;
  oIndDriver << "               char message[] =\"An unknown exception occurred in data simulation.\";" << endl;
  ...
  oIndDriver << "            catch( const std::exception& stde )" << endl;
  oIndDriver << "            {" << endl;
  oIndDriver << "               char message[] = \"A standard exception occurred in parameter estimation.\";" << endl;
  oIndDriver << "               SpkError e( stde, message, __LINE__, __FILE__ );" << endl;
  oIndDriver << "               errors.push( e );" << endl;
  ...
  oIndDriver << "            catch( ... )" << endl;
  oIndDriver << "            {" << endl;
  oIndDriver << "               char message[] = \"An unknown exception occurred in parameter estimation.\";" << endl;
  oIndDriver << "               SpkError e( SpkError::SPK_UNKNOWN_ERR, message, __LINE__, __FILE__ );" << endl;
  oIndDriver << "               errors.push( e );" << endl;
  oIndDriver << "               isOptSuccess = false;" << endl;
  oIndDriver << "               ret = OPTIMIZATION_ERROR;" << endl;
  ...
  oIndDriver << "               errors.cat( e );" << endl;
  oIndDriver << "               ret = OPT_OK_RESID_ERROR;" << endl;
  oIndDriver << "            }" << endl;
  oIndDriver << "            catch( const std::exception& stde )" << endl;
  oIndDriver << "            {" << endl;
  oIndDriver << "               char message[] = \"A standard exception occurred in residuals calculation.\";" << endl;
  oIndDriver << "               SpkError e( stde, message, __LINE__, __FILE__ );" << endl;
  oIndDriver << "               errors.push( e );" << endl;
  oIndDriver << "               ret = OPT_OK_RESID_ERROR;" << endl;
  oIndDriver << "            }" << endl;
  oIndDriver << "            catch( ... )" << endl;
  oIndDriver << "            {" << endl;
  oIndDriver << "               char message[] = \"An unknown exception occurred in residuals calculation.\";" << endl;
  oIndDriver << "               SpkError e( SpkError::SPK_UNKNOWN_ERR, message, __LINE__, __FILE__ );" << endl;
  oIndDriver << "               errors.push( e );" << endl;
  oIndDriver << "               ret = OPT_OK_RESID_ERROR;" << endl;
  oIndDriver << "            }" << endl;
 ...
 oIndDriver << "         if( isStatRequested && isOptRequested && isOptSuccess )" << endl;
  ...
  oIndDriver << "            try" << endl;
  oIndDriver << "            {" << endl;
  oIndDriver << "               // Set this so that no individual level optimization" << endl;
  oIndDriver << "               // is performed." << endl;
  oIndDriver << "               indOpt.setNMaxIter( 0 );" << endl;
  oIndDriver << endl;
  oIndDriver << "               // Evaluate the Hessian of the objective function" << endl;
  oIndDriver << "               // at bOut." << endl;
  oIndDriver << "               fitIndividual( model," << endl;
  oIndDriver << "                              y," << endl;
  oIndDriver << "                              indOpt," << endl;
  oIndDriver << "                              bLow," << endl;
  ...
  oIndDriver << "               ret = OPT_OK_STAT_ERROR;" << endl;
  oIndDriver << "            }" << endl;
  oIndDriver << "            catch( const std::exception& stde )" << endl;
  oIndDriver << "            {" << endl;
  oIndDriver << "               char message[] = \"A standard exception occurred in statistics calculation.\";" << endl;
  oIndDriver << "               SpkError e( stde, message, __LINE__, __FILE__ );" << endl;
  oIndDriver << "               errors.push( e );" << endl;
  oIndDriver << "               isStatSuccess &= false;" << endl;
  oIndDriver << "               ret = OPT_OK_STAT_ERROR;" << endl;
  ...
  oIndDriver << "            catch( ... )" << endl;
  oIndDriver << "            {" << endl;
  oIndDriver << "               char message[] = \"An unknown exception occurred in statistics calculation.\";" << endl;
  oIndDriver << "               SpkError e( SpkError::SPK_UNKNOWN_ERR, message, __LINE__, __FILE__ );" << endl;
  oIndDriver << "               errors.push( e );" << endl;
  oIndDriver << "               isStatSuccess &= false;" << endl;
  oIndDriver << "               ret = OPT_OK_STAT_ERROR;" << endl;
  ...
  oIndDriver << "      oResults << \"<?xml version=\\\"1.0\\\"?>\" << endl;" << endl;
  oIndDriver << "      oResults << \"<spkreport>\" << endl;" << endl;
  oIndDriver << "      oResults << \"<error_list length=\\\"\" << 1 << \"\\\">\" << endl;" << endl;
  oIndDriver << "      SpkError e( stde, \"A standard exception occurred.\", __LINE__, __FILE__ );" << endl;
  oIndDriver << "      oResults << e << endl;" << endl;
  oIndDriver << "      oResults << \"</error_list>\" << endl;" << endl;
  oIndDriver << "      oResults << \"</spkreport>\" << endl;" << endl;
  oIndDriver << "      oResults.close();" << endl;
  ...
  oIndDriver << "      oResults << \"<spkreport>\" << endl;" << endl;
  oIndDriver << "      oResults << \"<error_list length=\\\"\" << 1 << \"\\\">\" << endl;" << endl;
  oIndDriver << "      SpkError e( SpkError::SPK_UNKNOWN_ERR, \"An unknown exception occurred.\", __LINE__, __FILE__ );" << endl;
  oIndDriver << "      oResults << e << endl;" << endl;
  oIndDriver << "      oResults << \"</error_list>\" << endl;" << endl;
  oIndDriver << "      oResults << \"</spkreport>\" << endl;" << endl;
  oIndDriver << "      oResults.close();" << endl;
