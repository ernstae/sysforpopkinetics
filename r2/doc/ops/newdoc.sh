...
# To set up a directory for the development of a new OPS document,
# execute this command from the r2/doc/ops directory in your 
# CVS sandbox:
#
...
if [ $# -eq 0 ] || [ $1 == -h ] || [ $1 == --help ]; then
    ...
    echo -e "\tSUBJECT is the subject of your operations procedure"
...
ssh $WEBHOST "mkdir $WEBDIR/ops/$SUBJECT > /dev/null 2>&1"
