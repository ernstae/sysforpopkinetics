...
public class ErrorDialog extends javax.swing.JDialog {
    ...
    public ErrorDialog(java.awt.Frame parent, String[] modelExpression, String name)
    {
        super(parent, true);
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jTextArea1.setText("Select or enter a residual unknown variability model for the \nobservation.  Here F denotes the model function vector.  DV\nrepresents the observed data vector, and EPS represents the\nresidual unknown variability.  Y is a random variable standing \nfor the predicted observation.  Make sure that an appropriate \nnumber is inserted in each parenthesis following a parameter. ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        proportionalRadioButton.setText("Model-based Weighting");
        ...
        exponentialRadioButton.setText("Data-Based Weighting");
    ...
    private void exponentialRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exponentialRadioButtonActionPerformed
        userDefinedTextField.setText("Y = F + DV * EPS()");
    ...
    private void proportionalRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proportionalRadioButtonActionPerformed
        userDefinedTextField.setText("Y = F + F * EPS()");
    ...
    private void additiveRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_additiveRadioButtonActionPerformed
        userDefinedTextField.setText("Y = F + EPS()");
    ...
    public static void main(String args[]) {
        ...
        new ErrorDialog(new javax.swing.JFrame(), model, "name");
        expression = model[0];
