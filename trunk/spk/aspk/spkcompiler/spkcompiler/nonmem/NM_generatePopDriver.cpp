...
void NonmemTranslator::generatePopDriver() const
{
  ...
  oPopDriver << "      valarray<double> predTrancatedOut      ( nY );"      << endl;
  oPopDriver << "      valarray<double> resTrancatedOut       ( nY );"      << endl;
  oPopDriver << "      valarray<double> resWtdTrancatedOut    ( nY );"      << endl;
  oPopDriver << endl;
  ...
  oPopDriver << "                            &predTrancatedOut, " << endl;
  oPopDriver << "                            &resTrancatedOut, " << endl;
  oPopDriver << "                            &resWtdTrancatedOut, " << endl;
  oPopDriver << "                            &parResOut, " << endl;
  oPopDriver << "                            &parResWtdOut );" << endl;
  oPopDriver << "               dataForDisposal.expand( predTrancatedOut,   predOut );" << endl;
  oPopDriver << "               dataForDisposal.expand( resTrancatedOut,    resOut );" << endl;
  oPopDriver << "               dataForDisposal.expand( resWtdTrancatedOut, resWtdOut );" << endl;
  oPopDriver << "               }" << endl;
  oPopDriver << "            catch( SpkException& e )" << endl;
  oPopDriver << "            {" << endl;
