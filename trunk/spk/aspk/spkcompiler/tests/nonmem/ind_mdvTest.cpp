...
if( actual != expected ) \\\n \
 { \\\n \
  ...
  const int    nFixed     =  0;
  const int    nItems     =  3;
  const double record0[]  = { 0.0, 0.0, 1 };
  const double record1[]  = { 0.1, 0.2, 0 };
  const double record2[]  = { 338.8, 337.4, 0 };
  const double record3[]  = { 118.1, 118.2, 0 };
  const double record4[]  = { 888.0, 884.6, 0 };
  const double record5[]  = { 9.2, 10.1, 0 };
  const double record6[]  = { 228.1, 226.5, 0 };
  const double record7[]  = { 668.5, 666.3, 0 };
  const double record8[]  = { 998.5, 996.3, 0 };
  const double record9[]  = { 449.1, 448.6, 0 };
  const double record10[] = { 778.9, 777.0, 0 };
  const double record11[] = {   0.0,   0.0, 1 };
  const double record12[] = { 559.2, 558.2, 0 };
  const double record13[] = { 0.3, 0.4, 0 };
  const double record14[] = { 0.1, 0.6, 0 };
  const double record15[] = { 778.1, 775.5, 0 };
  const double record16[] = { 668.8, 666.9, 0 };
  const double record17[] = { 339.3, 338.0, 0 };
  const double record18[] = { 448.9, 447.5, 0 };
  const double record19[] = { 10.8, 11.6, 0 };
  const double record20[] = { 557.7, 556.0, 0 };
  const double record21[] = { 228.3, 228.1, 0 };
  const double record22[] = { 998.0, 995.8, 0 };
  const double record23[] = { 888.8, 887.6, 0 };
  const double record24[] = { 119.6, 120.2, 0 };
  const double record25[] = { 0.3, 0.3, 0 };
  const double record26[] = { 0.6, 0.3, 0 };
  const double record27[] = { 557.6, 556.8, 0 };
  const double record28[] = { 339.3, 339.1, 0 };
  const double record29[] = { 888.0, 887.2, 0 };
  const double record30[] = { 998.5, 999.0, 0 };
  const double record31[] = { 778.9, 779.0, 0 };
  const double record32[] = { 10.2, 11.1, 0 };
  const double record33[] = { 117.6, 118.3, 0 };
  const double record34[] = { 228.9, 229.2, 0 };
  const double record35[] = { 668.4, 669.1, 0 };
  const double record36[] = { 449.2, 448.9, 0 };
  const double record37[] = { 0.2, 0.5, 0 };
...
void ind_mdvTest::testNonmemPars_h()
{
  //============================================
...
void ind_mdvTest::testIndDataClass()
{
  ...
  o << "   MY_ASSERT_EQUAL( " << nDVs << ", y.size() );" << endl;
  ...
  o << "   MY_ASSERT_EQUAL( -1, A.getMeasurementIndex( 0 ) );" << endl;
  o << "   MY_ASSERT_EQUAL( -1, A.getMeasurementIndex( 11 ) );" << endl;
  o << "   MY_ASSERT_EQUAL(  1, A.getRecordIndex( 0 ) );" << endl;
  o << "   MY_ASSERT_EQUAL( 12, A.getRecordIndex( 10 ) );" << endl;
  o << "   return 0;" << endl;
  o << "}" << endl;
  o.close();
