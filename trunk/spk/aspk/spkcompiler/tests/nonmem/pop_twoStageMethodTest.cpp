...
#ifndef NDEBUG
  char CXXFLAGS[]   = "-g -I./ -I../ -I../../spkcompiler -I/usr/local/include/spktest -I/usr/local/include/spktest/CppAD";
#else
  char CXXFLAGS[]   = "-O3 -Dspk_release -DNDEBUG -I./ -I../ -I../../spkcompiler -I/usr/local/include/spktest -I/usr/local/include/spktest/CppAD";
#endif
  char LDFLAG[514];
...
if( actual != expected ) \\\n \
 { \\\n \
  ...
  const char method[]   = "std_two_stage";
  ...
  // PRED model
  //
  // Note that for two-stage methods the Pred block expressions use
  // individual model notation.
  //
  // KA=THETA(1)
  // KE=THETA(2)
  // F=KE*KA
...
void pop_twoStageMethodTest::setUp()
{
  okToClean = false;
...
void pop_twoStageMethodTest::tearDown()
{
  if( okToClean )
    {
      remove( fDataML );
...
//
//******************************************************************************
void pop_twoStageMethodTest::createDataML()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_twoStageMethodTest::createSourceML()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
// 
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void pop_twoStageMethodTest::parse()
{
  //============================================
...
void pop_twoStageMethodTest::testIndDataClass()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_twoStageMethodTest::testDataSetClass()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_twoStageMethodTest::testPredClass()
{ 
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_twoStageMethodTest::testDriver()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  int  exitcode      = 0;
  char command[1024];
  snprintf( command, MAXCHARS, "make -f %s test", fMakefile );
  if( system( command ) != 0 )
    {
      char message[MAXCHARS+1];
...
void pop_twoStageMethodTest::testReportML()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  // Test driver.cpp to see if it compiles/links successfully.
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
CppUnit::Test * pop_twoStageMethodTest::suite()
{
  CppUnit::TestSuite *suiteOfTests = new CppUnit::TestSuite( "pop_twoStageMethodTest"  );
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_twoStageMethodTest>(
         "testIndDataClass", 
	 &pop_twoStageMethodTest::testIndDataClass ) );
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_twoStageMethodTest>(
         "testDataSetClass", 
	 &pop_twoStageMethodTest::testDataSetClass ) );
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_twoStageMethodTest>(
         "testPredClass", 
	 &pop_twoStageMethodTest::testPredClass ) );
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_twoStageMethodTest>(
         "testDriver", 
	 &pop_twoStageMethodTest::testDriver ) );
  return suiteOfTests;
}
