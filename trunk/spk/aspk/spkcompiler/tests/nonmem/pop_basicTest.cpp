...
#ifndef NDEBUG
  char CPPFLAG[]    = "-g -DSachiko -I./ -I../ -I../../spkcompiler -I/usr/local/include/spktest -I/usr/local/include/spktest/CppAD";
#else
...
void pop_basicTest::testDriver()
{
  ...
  if( system( command ) != 0 )
    {
      char message[256];
      sprintf( message, "Compilation of the generated %s failed!", fFitDriver );
