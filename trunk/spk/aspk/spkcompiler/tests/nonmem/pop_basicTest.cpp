...
//
//******************************************************************************
void pop_basicTest::createDataML()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_basicTest::createSourceML()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_basicTest::testIndDataClass()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_basicTest::testDataSetClass()
{
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
void pop_basicTest::testPredClass()
{ 
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //
...
{
  CppUnit::TestSuite *suiteOfTests = new CppUnit::TestSuite( "pop_basicTest"  );
  ...
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_basicTest>(
         "testDataSetClass", 
	 &pop_basicTest::testDataSetClass ) );
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_basicTest>(
         "testPredClass", 
	 &pop_basicTest::testPredClass ) );
  suiteOfTests->addTest( 
     new CppUnit::TestCaller<pop_basicTest>(
         "testDriver", 
