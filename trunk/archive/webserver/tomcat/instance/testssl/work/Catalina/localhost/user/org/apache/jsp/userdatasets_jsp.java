  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (request) {
        datasets = (uw.rfpk.beans.DatasetList) pageContext.getAttribute("datasets", PageContext.REQUEST_SCOPE);
        if (datasets == null){
          datasets = new uw.rfpk.beans.DatasetList();
          pageContext.setAttribute("datasets", datasets, PageContext.REQUEST_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("              ");
